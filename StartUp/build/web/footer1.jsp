<%-- 
    Document   : footer1
    Created on : 25 Jun, 2018, 6:22:10 PM
    Author     : iamaj
--%>
	...
	<div class="social-media">
		<ul class="list-inline">
			...
			<li><a href="http://www.nextbootstrap.com/" title=""><i class="fa fa-linkedin"></i></a></li>
                        <li><a href="http://www.nextbootstrap.com/" title=""><i class="fa fa-youtube"></i></a></li>
                        <li><a href="http://www.nextbootstrap.com/" title=""><i class="fa fa-github"></i></a></li>
